...
namespace HRworksConnector.Models.GeneralActions
{
    ...
    {
        public IList<HRworksConnector.Models.GeneralActions.PersonWorkingHours> PersonsWorkingHours { get; set; }

        public GetAvailableWorkingHoursResponse()
        {
            this.PersonsWorkingHours = new System.Collections.Generic.List<HRworksConnector.Models.GeneralActions.PersonWorkingHours>();
        }
    }
    ...
    public class PersonWorkingHours
    {
        ...
        public IList<HRworksConnector.Models.GeneralActions.WorkHours> WorkingHours { get; set; }

        public PersonWorkingHours()
        {
            this.WorkingHours = new System.Collections.Generic.List<HRworksConnector.Models.GeneralActions.WorkHours>();
        }
    }
    ...
    public class GetAvailableWorkingHoursConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public override object ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, object existingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            foreach (KeyValuePair<string, Newtonsoft.Json.Linq.JToken> personWorkHours in getAvailableWorkingHoursResponseAsJson)
            {
                ...
                {
                    HRworksConnector.Models.GeneralActions.WorkHours tmpWorkHours = workHour.ToObject<HRworksConnector.Models.GeneralActions.WorkHours>();
